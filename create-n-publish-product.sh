...
jq '.state = "active" | del(.references) | del(.latestrelease)' ./json_files/asset-updated.json > ./json_files/asset-updated.tmp && mv ./json_files/asset-updated.tmp ./json_files/asset-updated.json
...
#echo $(cat ./json_files/product-updated.json | jq 'del(. | .references?)') > ./json_files/product-updated.json
jq 'del(.references, .metadata.references, .metadata.resourceVersion, .metadata.id, .latestrelease)' ./json_files/product-updated.json > ./json_files/product-updated.tmp && mv ./json_files/product-updated.tmp ./json_files/product-updated.json
